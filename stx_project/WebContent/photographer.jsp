        ...
        <ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-6 am-thumbnails" id="topface">
            <li>
                ...
                <div class="ctl active">
                    <img src="/stx_project/Temp-images/sheyingshi1.jpg">
                    <h3>一号摄影师</h3>
                    <p>MMM</p>
                </div>
            ...
            <li>
                <a href="person.jsp">
                    <div class="ctl">
                        <img src="/stx_project/Temp-images/sheyingshi5.jpg">
                        <h3>五号摄影师</h3>
                        <p>去哪</p>
                    </div>
                    <button type="button" class="am-btn am-btn-default">进入专栏</button>
            ...
            <li>
                <a href="person.jsp">
                    <div class="ctl">
                        <img src="/stx_project/Temp-images/sheyingshi6.jpg">
                        <h3>六号摄影师</h3>
                        <p>Yahoo</p>
                    </div>
                    <button type="button" class="am-btn am-btn-default">进入专栏</button>
        ...
        <li>
            <div class="cattlist_0">
                ...
                <div class="cattlist_3">
                    <button type="button" class="am-btn am-btn-warning" onclick="window.open('person.html')">
...
<!--                        <i class="am-icon-plus"></i>-->
        ...
        <li>
            <div class="cattlist_0">
                ...
                <div class="cattlist_3">
                    <button type="button" class="am-btn am-btn-warning" onclick="window.open('person.html')">更多</button>
                </div>
            </div>
        </li>
