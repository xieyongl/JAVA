	...
	<div class="wrapper">
	    <div class="sidebar" data-color="purple" data-image="../assets/img/sidebar-1.jpg">
	    	...
	    	<div class="sidebar-wrapper">
	            <ul class="nav">
	                <li class="active">
	                    <a href="/stx_project/admin/article2.jsp" target="right">
	                ...
	                <li>
	                    <a href="/stx_project/admin/reservation2.jsp" target="right" >
	                        <i class="material-icons">&nbsp&nbsp&nbsp</i>
	                        <p>预约管理</p>
	                    </a>
	                </li>
			...
			<div class="content">
				<div class="container-fluid">
					<div class="row" style="margin-top: -15px;">
						<iframe src="/stx_project/admin/article2.jsp" width="100%" height="900" name="right" style="border: none;"></iframe>
					</div>
				</div>
			</div>
		</div>
